    ...
    <div class="container">
        ...
        <div class="summary-section no-print" style="margin-top: 10px; margin-bottom: 0;">
            <div style="display: flex; justify-content: flex-end; gap: 10px;">
                <a href="{{ route('reports.export', ['type' => 'sales']) }}" 
        ...
        <div class="summary-section">
            ...
            <form method="GET" action="{{ route('reports.sales') }}" class="no-print" style="margin-bottom:15px;">
            ...
            <div class="table-wrapper">
                <table>
                    ...
                    <tbody>
                        ...
                        @empty
                            <tr>
                                <td colspan="7" style="text-align:center;">Belum ada data transaksi penjualan.</td>
                            </tr>
                        @endforelse
                    </tbody>
                </table>
