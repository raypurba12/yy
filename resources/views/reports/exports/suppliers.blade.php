...
<body>
    <div class="container">
        ...
        <div class="summary-section">
            <div class="summary-title">DAFTAR SEMUA PEMBELIAN SUPPLIER</div>
            ...
            <table>
                <thead>
                    <tr>
                        ...
                        <th style="width: 10%;text-align:right;">Jumlah (Kg)</th>
                ...
                <tbody>
                    ...
                    @empty
                        <tr>
                            <td colspan="8" class="text-center">Belum ada data transaksi pembelian supplier.</td>
                        </tr>
                    @endforelse
                </tbody>
            </table>
