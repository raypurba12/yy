...
<body>
    ...
    <div class="container">
        ...
        <!-- All Supplier Purchases Table -->
        <div class="summary-section">
            <div class="summary-title">DAFTAR SEMUA SUPPLIER</div>

            <!-- Filter Tanggal (disembunyikan saat cetak) -->
            <form method="GET" action="{{ route('reports.suppliers') }}" class="no-print" style="margin-bottom:15px;">
                ...
                <table>
                    <thead>
                        <tr>
                            ...
                            <th style="width:22%;">No. Pembelian</th>
                            ...
                            <th style="width:11%;text-align:right;">Total Harga</th>
                        </tr>
                    </thead>
                    <tbody>
                        @forelse($supplierPurchases as $index => $row)
                            <tr>
                                ...
                                <td style="text-align:right;">{{ number_format($row->quantity ?? 0, 0, ',', '.') }} Kg</td>
                                <td style="text-align:right;">Rp {{ number_format($row->unit_price ?? 0, 0, ',', '.') }}</td>
                                <td style="text-align:right;">Rp {{ number_format($row->total_price ?? 0, 0, ',', '.') }}</td>
                            </tr>
                        @empty
                            <tr>
                                <td colspan="7" style="text-align:center;">Belum ada data pembelian supplier atau restock.</td>
                            </tr>
                        @endforelse
                    </tbody>
                </table>
